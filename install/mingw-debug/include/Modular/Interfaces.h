...
extern "C" {
    ...
    struct Modular_RuntimeHostApi {
        void* (*getService)(void* self, const char* service);
    ...
    struct Modular_OnLoadHostApi {
        bool (*registerService)(void* self, const char* service, void* ptr);
        void (*log)(void* self, const char* message);
        void* self;
    };
...
namespace Modular {
    ...
    using GetServiceFn = void* (*)(void* self, const char* service);
    using RegisterServiceFn = bool (*)(void* self, const char* service, void* ptr);
    ...
    public:
        ...
        void* getService(const char* name) {
            return m_api->getService(m_api->self, name);
        }
    ...
    public:
        ...
        bool registerService(const char* name, void* ptr) {
            return m_api->registerService(m_api->self, name, ptr);
        }
